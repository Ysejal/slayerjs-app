  ...
  switch (option) {
    ...
    case "rest":
      ...
      if (Math.floor(player.health + twentyFivePercent) > player.maxHealth) {
        ...
        dispatch(
          updatePlayer({
            health: Math.floor(player.health + twentyFivePercent),
          })
        );
      }
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ display: "flex", flexDirection: "row" }}>
            <button
              ...
              className={styles.bonfireOption}
              onClick={() => handleOption("cleanse", dispatch, player)}
            >
              🕯️ Cleanse
              <div className={styles.subtext}>
                Remove all curses from deck...
              </div>
            </button>
            ...
            <button
              ...
              onMouseEnter={() => playMenuSound()}
              className={styles.bonfireOption}
              onClick={() => handleOption("rest", dispatch, player)}
            >
              🔥 Rest
              <div className={styles.subtext}>
                Heal 25% of parties health points...
              </div>
            </button>
            ...
            <button
              id="resurectButton"
              onMouseEnter={() => playMenuSound()}
              className={styles.bonfireOptionOff}
            >
              ✨ Resurrect
              <div className={styles.subtext}>
                Resurect all dead heros... [ currently not in the game ]
              </div>
            </button>
          </div>
        </div>
